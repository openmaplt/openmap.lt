    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
          Žemiau pateikta techninė informacija tiems, kas žymi objektus atvirame
          žemėlapyje <strong>OpenStreetMap (OSM)</strong>. Čia nurodyta, kokios
          žymos (tags) ir sąlygos turi būti priskirtos objektui, kad jis
          atsirastų atitinkamame šio žemėlapio sluoksnyje.
        </p>
        <div className="p-4 bg-muted/40 rounded-xl border text-xs text-muted-foreground flex gap-2">
          ...
          <p>
            ...
            objektu, tačiau nenorite gilintis į atvirojo žemėlapio subtilybes ir
            žymėjimą, galite tiesiog{" "}
            <a
              href="/prisidekite"
